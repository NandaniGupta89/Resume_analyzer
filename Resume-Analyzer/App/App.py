...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Nandani@014',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://nandanigupta.netlify.app/" style="text-decoration: none; color: #021659;">Nandani Gupta</a></b>'
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>user</b> as username and <b>password</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by 
            <a href="https://nandanigupta.netlify.app/" style="text-decoration: none; color: grey;">Nandani Gupta</a>
            <a href="https://www.linkedin.com/in/nandanigupta0148/" style="text-decoration: none; color: grey;">(Data analyst)</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'nandani' and ad_password == 'nandani@14':
                ...
                st.success("Welcome Nandani ! Total %d " % values + " User's Have Used Our Tool : )")
